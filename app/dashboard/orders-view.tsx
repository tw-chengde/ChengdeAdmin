...
function channelStyle(channelCode: OrderItem["channelCode"]) {
...
export default function OrdersView() {
  const [channelTab, setChannelTab] = useState<"ALL" | "MOMO_MAIN" | "MO_STORE_PLUS">("ALL");
  ...
  }, [channelTab, statusTab, searchQuery]);

  const stats = useMemo(() => {
    const channelFiltered = mockOrders.filter((o) => {
